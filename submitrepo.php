...
$DateOfReport = mysqli_real_escape_string($dbc, $_GET['Date']);

$query = "INSERT INTO Report (name, sex, country, age, abuse_type, perpetrators_sex, perpetrators_name, perpetrators_age, date_of_report) VALUES ('$Name', '$Sex', '$Country', '$Age', '$AbuseType', '$PerpetratorSex', '$PerpetratorName', '$PerpetratorAge', '$DateOfReport')";
